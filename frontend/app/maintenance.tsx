...
const styles = StyleSheet.create({
  ...
  statLabel: { color: theme.colors.textMuted, fontSize: 8, fontWeight: "800", letterSpacing: 1.2, marginTop: 2 },
  horizonRow: {
    flexDirection: "row",
  ...
  horizonText: { color: theme.colors.textSecondary, fontWeight: "800", fontSize: 10, letterSpacing: 1 },
  horizonTextOn: { color: "#000" },
  empty: { alignItems: "center", paddingVertical: 60, gap: 12 },
  emptyTitle: { color: theme.colors.textPrimary, fontWeight: "900", letterSpacing: 2, fontSize: 11 },
  emptyText: { color: theme.colors.textMuted, fontSize: 10, textAlign: "center", lineHeight: 15, paddingHorizontal: 30 },
  itemCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  itemTool: { color: theme.colors.textPrimary, fontWeight: "800", fontSize: 11 },
  itemType: { color: theme.colors.accent, fontSize: 9, fontWeight: "700", marginTop: 3, letterSpacing: 0.5 },
  itemDate: { color: theme.colors.textMuted, fontSize: 9, marginTop: 3 },
  daysBadge: {
  ...
  daysText: { color: theme.colors.textPrimary, fontWeight: "900", fontSize: 9, letterSpacing: 0.5 },
});

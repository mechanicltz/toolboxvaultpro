...
const styles = StyleSheet.create({
  ...
  title: { color: theme.colors.textPrimary, fontSize: 13, fontWeight: "900", letterSpacing: 2, flex: 1, textAlign: "center" },
  ...
  bigAvatarText: { color: theme.colors.accent, fontWeight: "900", fontSize: 18, letterSpacing: 2 },
  bigName: { color: theme.colors.textPrimary, fontSize: 18, fontWeight: "900", letterSpacing: 1, marginTop: 12 },
  contact: { color: theme.colors.textSecondary, fontSize: 11, marginTop: 4 },
  actionsWrap: {
    flexDirection: "row",
    flexWrap: "wrap",
  ...
  rankText: { color: theme.colors.accent, fontWeight: "900", fontSize: 11 },
  thumb: {
    width: 36, height: 36, borderRadius: 4, overflow: "hidden",
    backgroundColor: theme.colors.surface,
    alignItems: "center", justifyContent: "center",
  },
  rowName: { color: theme.colors.textPrimary, fontWeight: "700", fontSize: 11 },
  rowMeta: { color: theme.colors.textSecondary, fontSize: 9, marginTop: 2 },
  rowNotes: { color: theme.colors.textMuted, fontStyle: "italic", fontSize: 9, marginTop: 4 },
  countPill: {
    flexDirection: "row", alignItems: "center", gap: 2,
    paddingHorizontal: 10, paddingVertical: 6,
    backgroundColor: theme.colors.accent, borderRadius: 4,
  },
  countNum: { color: "#000", fontWeight: "900", fontSize: 11 },
  countLbl: { color: "#000", fontWeight: "900", fontSize: 9 },
  histRow: {
  ...
  histTool: { color: theme.colors.textPrimary, fontWeight: "700", fontSize: 11 },
  histTime: { color: theme.colors.textSecondary, fontSize: 9, marginTop: 2 },

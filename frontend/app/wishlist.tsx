...
const styles = StyleSheet.create({
  ...
  statValue: { color: theme.colors.textPrimary, fontSize: 15, fontWeight: "900" },
  ...
  tabText: { color: theme.colors.textSecondary, fontSize: 10, fontWeight: "800", letterSpacing: 1.5 },
  ...
  itemName: { flex: 1, color: theme.colors.textPrimary, fontSize: 13, fontWeight: "700" },
  ...
  itemDesc: { color: theme.colors.textSecondary, fontSize: 11, marginTop: 6 },
  metaRow: { flexDirection: "row", gap: 14, marginTop: 8 },
  priceText: { color: theme.colors.accent, fontSize: 11, fontWeight: "800" },
  dealerText: { color: theme.colors.textMuted, fontSize: 9, fontWeight: "700", letterSpacing: 0.5 },
  notesText: { color: theme.colors.textMuted, fontSize: 9, fontStyle: "italic", marginTop: 6 },
  ...
  linkText: { color: theme.colors.accentSecondary, fontWeight: "800", fontSize: 9, letterSpacing: 1 },
  iconBtn: {
  ...
  toolLinkText: { color: theme.colors.accent, fontSize: 8, fontWeight: "800", letterSpacing: 1 },
  fab: {
    position: "absolute",
    bottom: 24, right: 24,
  ...
  label: { color: theme.colors.textMuted, fontSize: 8, fontWeight: "800", letterSpacing: 1.5, marginTop: 8, marginBottom: 4 },
  input: {
    backgroundColor: theme.colors.surfaceAlt,
    borderWidth: 1, borderColor: theme.colors.border,
    color: theme.colors.textPrimary, paddingHorizontal: 12, paddingVertical: 10,
    borderRadius: theme.radii.sm, fontSize: 11,
  },
  prioChip: {
  ...
  prioChipText: { color: theme.colors.textSecondary, fontSize: 7, fontWeight: "900", letterSpacing: 1 },
  dealerChip: {
  ...
  dealerChipText: { color: theme.colors.textSecondary, fontSize: 8, fontWeight: "800", letterSpacing: 1 },
  ...
  btnText: { color: "#000", fontWeight: "800", letterSpacing: 2, fontSize: 11 },
  btnGhost: {
    flex: 1, height: 48, alignItems: "center", justifyContent: "center",

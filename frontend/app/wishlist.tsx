...
const styles = StyleSheet.create({
  ...
  statValue: { color: theme.colors.textPrimary, fontSize: 14, fontWeight: "900" },
  ...
  tabText: { color: theme.colors.textSecondary, fontSize: 9, fontWeight: "800", letterSpacing: 1.5 },
  tabTextActive: { color: "#000" },
  empty: { alignItems: "center", marginTop: 60, paddingHorizontal: 40 },
  emptyTitle: { color: theme.colors.textPrimary, fontSize: 12, fontWeight: "900", letterSpacing: 2, marginTop: 16 },
  emptyText: { color: theme.colors.textSecondary, fontSize: 10, textAlign: "center", marginTop: 8 },
  card: {
    backgroundColor: theme.colors.bgSecondary,
    marginHorizontal: 16,
    marginBottom: 12,
  ...
  itemName: { flex: 1, color: theme.colors.textPrimary, fontSize: 12, fontWeight: "700" },
  ...
  itemDesc: { color: theme.colors.textSecondary, fontSize: 10, marginTop: 6 },
  metaRow: { flexDirection: "row", gap: 14, marginTop: 8 },
  priceText: { color: theme.colors.accent, fontSize: 10, fontWeight: "800" },
  dealerText: { color: theme.colors.textMuted, fontSize: 8, fontWeight: "700", letterSpacing: 0.5 },
  notesText: { color: theme.colors.textMuted, fontSize: 8, fontStyle: "italic", marginTop: 6 },
  ...
  linkText: { color: theme.colors.accentSecondary, fontWeight: "800", fontSize: 8, letterSpacing: 1 },
  iconBtn: {
  ...
  toolLinkText: { color: theme.colors.accent, fontSize: 7, fontWeight: "800", letterSpacing: 1 },
  fab: {
    position: "absolute",
    bottom: 24, right: 24,
  ...
  modalTitle: { color: theme.colors.textPrimary, fontSize: 14, fontWeight: "900", letterSpacing: 2, marginBottom: 12 },
  label: { color: theme.colors.textMuted, fontSize: 7, fontWeight: "800", letterSpacing: 1.5, marginTop: 8, marginBottom: 4 },
  input: {
  ...
  dealerChipText: { color: theme.colors.textSecondary, fontSize: 7, fontWeight: "800", letterSpacing: 1 },

...
const styles = themedStyles((c) => ({
  ...
  label: { color: c.textMuted, fontSize: 8, fontWeight: "800", letterSpacing: 1.5, marginBottom: 6, marginTop: 4 },
  input: {
  ...
  helper: { color: c.textMuted, fontSize: 11, marginTop: 8, lineHeight: 16 },
  smallBtn: {
    flexDirection: "row", alignItems: "center", gap: 4,
    borderWidth: 1.5, borderColor: c.accent, borderRadius: 6,
  ...
  smallBtnText: { color: c.accent, fontSize: 9, fontWeight: "900", letterSpacing: 1 },
  ...
  itemName: { color: c.textPrimary, fontSize: 12, fontWeight: "800" },
  itemSub: { color: c.textMuted, fontSize: 9, fontWeight: "700", letterSpacing: 0.5, marginTop: 2 },
  saveBtn: {
  ...
  modalCard: {
    backgroundColor: c.bgSecondary, borderTopLeftRadius: 18, borderTopRightRadius: 18,
    padding: 20, paddingBottom: 34,
  },
  modalTitle: { color: c.textPrimary, fontSize: 13, fontWeight: "900", letterSpacing: 2 },
  btnGhost: { paddingVertical: 12, alignItems: "center", marginTop: 8 },
  btnGhostText: { color: c.accent, fontWeight: "900", fontSize: 11, letterSpacing: 1 },
}));

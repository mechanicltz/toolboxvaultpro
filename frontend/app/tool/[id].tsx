...
import { PRINT_LOGO_DATA_URI } from "../../src/printLogo";
...
<body>
  ...
  <table class="footer-band" style="width:100%; border-collapse:collapse;"><tr>
    <td style="width:50%; text-align:right; color:#999999; font-size:8pt; letter-spacing:2pt; border:0; vertical-align:middle;">GENERATED BY&nbsp;&nbsp;</td>
    <td style="text-align:center; white-space:nowrap; border:0; vertical-align:middle;"><img src="${PRINT_LOGO_DATA_URI}" style="height:17px; vertical-align:middle;" /></td>
    <td style="width:50%; text-align:left; color:#999999; font-size:8pt; letter-spacing:2pt; border:0; vertical-align:middle;">&nbsp;&nbsp;&middot;&nbsp;&nbsp;${new Date().toLocaleDateString()}</td>
  </tr></table>

...
const styles = StyleSheet.create({
  ...
  topTitle: { color: theme.colors.textPrimary, fontSize: 12, fontWeight: "900", letterSpacing: 2 },
  saveText: { color: theme.colors.accent, fontWeight: "900", letterSpacing: 2, fontSize: 10 },
  label: {
  ...
  helper: { color: theme.colors.textMuted, fontStyle: "italic", fontSize: 10 },
  ...
  chipText: { color: theme.colors.textSecondary, fontSize: 9, fontWeight: "700", letterSpacing: 0.5 },
  ...
  locText: { color: theme.colors.textPrimary, fontSize: 10, fontWeight: "600" },
  pickerRow: {
    flexDirection: "row", alignItems: "center", gap: 12,
    backgroundColor: theme.colors.bgSecondary, borderWidth: 1, borderColor: theme.colors.border,
    paddingHorizontal: 14, paddingVertical: 12, borderRadius: 4,
  },
  pickerText: { color: theme.colors.textPrimary, flex: 1, fontWeight: "600", fontSize: 10 },
  toggleRow: {
    flexDirection: "row", alignItems: "center", gap: 12,
    paddingVertical: 14, marginTop: 16,
    borderTopWidth: 1, borderTopColor: theme.colors.border,
  },
  toggleText: { color: theme.colors.textPrimary, fontSize: 10, fontWeight: "900", letterSpacing: 1.5, flex: 1 },
  subSection: {
  ...
  photoAddText: { color: theme.colors.accent, fontSize: 7, fontWeight: "800", letterSpacing: 1 },
  docRow: {
  ...
  docAddText: { color: theme.colors.accent, fontWeight: "800", letterSpacing: 1.5, fontSize: 9 },
  ...
  dealerOptSub: { color: theme.colors.textSecondary, fontSize: 9, marginTop: 2 },
  btnGhost: {

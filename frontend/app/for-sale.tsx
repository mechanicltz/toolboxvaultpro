...
const styles = themedStyles((c) => ({
  ...
  cardName: { color: c.textPrimary, fontWeight: "900", fontSize: 15 },
  ...
  cardPrice: { color: c.accent, fontSize: 16, fontWeight: "900" },
  ...
  listedPillText: { color: "#000", fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  soldPill: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  soldPillText: { color: "#fff", fontSize: 11, fontWeight: "900", letterSpacing: 1 },
  empty: { alignItems: "center", padding: 40, gap: 10 },
  emptyTitle: { color: c.textPrimary, fontSize: 16, fontWeight: "800" },
  emptyMsg: { color: c.textMuted, fontSize: 13, textAlign: "center", lineHeight: 18 },
  // Modal helpers
  modalBackdrop: { flex: 1, backgroundColor: "rgba(0,0,0,0.6)", alignItems: "center", justifyContent: "center", padding: 16 },
  modalCard: {
    width: "100%", maxWidth: 520, backgroundColor: c.bgSecondary,
    borderWidth: 1, borderColor: c.border, borderRadius: 12, padding: 18,
  },
  modalHeader: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 12 },
  modalTitle: { flex: 1, color: c.textPrimary, fontSize: 10, fontWeight: "900", letterSpacing: 1.5 },
  modalBtn: { paddingVertical: 12, borderRadius: 8, alignItems: "center" },
  modalBtnText: { fontWeight: "900", fontSize: 9, letterSpacing: 1.5 },
  fLabel: { color: c.textSecondary, fontSize: 8, fontWeight: "800", letterSpacing: 1.5, marginTop: 12, marginBottom: 4 },
  fSub: { color: c.textMuted, fontSize: 7, fontWeight: "700", letterSpacing: 1, marginBottom: 4 },
  chip: {
  ...
  reportOptTitle: { color: c.textPrimary, fontWeight: "900", fontSize: 10, letterSpacing: 1.5 },
  reportOptSub: { color: c.textMuted, fontSize: 8, marginTop: 2 },
}));

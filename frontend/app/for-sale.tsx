...
const styles = themedStyles((c) => ({
  ...
  cardPrice: { color: c.accent, fontSize: 14, fontWeight: "900" },
  cardMeta: { color: c.textSecondary, fontSize: 7, marginTop: 2 },
  listedPill: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  emptyTitle: { color: c.textPrimary, fontSize: 11, fontWeight: "800" },
  emptyMsg: { color: c.textMuted, fontSize: 9, textAlign: "center", lineHeight: 14 },
  // Modal helpers

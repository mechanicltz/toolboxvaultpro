...
const styles = StyleSheet.create({
  ...
  statValue: { color: theme.colors.textPrimary, fontSize: 16, fontWeight: "900" },
  ...
  dealerName: { color: theme.colors.textPrimary, fontWeight: "800", fontSize: 11 },
  ...
  bodyLabel: { color: theme.colors.textMuted, fontSize: 7, fontWeight: "800", letterSpacing: 1.5, marginTop: 4 },
  completedToggle: {
    flexDirection: "row", alignItems: "center", gap: 6, alignSelf: "flex-start",
    borderWidth: 1, borderColor: theme.colors.border,
    paddingHorizontal: 10, paddingVertical: 6, borderRadius: 3,
  },
  completedToggleText: { color: theme.colors.accent, fontSize: 7, fontWeight: "800", letterSpacing: 1 },
  muted: { color: theme.colors.textMuted, fontStyle: "italic", fontSize: 10, paddingVertical: 6 },
  claimCard: {
  ...
  claimTitle: { color: theme.colors.textPrimary, fontWeight: "700", fontSize: 10 },
  claimMeta: { color: theme.colors.textSecondary, fontSize: 8, marginTop: 2 },
  claimDate: { color: theme.colors.textMuted, fontSize: 7, marginTop: 2 },
  ...
  modalTitle: { color: theme.colors.textPrimary, fontSize: 14, fontWeight: "900", letterSpacing: 2 },
  modalSub: { color: theme.colors.textSecondary, fontSize: 9, marginTop: 4, marginBottom: 12 },
  filterDot: {
    position: "absolute",
    top: -2, right: -2,
  ...
  fLabel: { color: theme.colors.textMuted, fontSize: 7, fontWeight: "800", letterSpacing: 1.5, marginTop: 4, marginBottom: 6 },
  ...
  checkText: { color: theme.colors.textPrimary, fontSize: 10, fontWeight: "600" },
  dateInput: {

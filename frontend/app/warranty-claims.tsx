...
const styles = StyleSheet.create({
  ...
  statLabel: { color: theme.colors.textMuted, fontSize: 7, fontWeight: "800", letterSpacing: 1, marginTop: 4 },
  empty: { alignItems: "center", marginTop: 60, paddingHorizontal: 40 },
  emptyTitle: { color: theme.colors.textPrimary, fontSize: 13, fontWeight: "900", letterSpacing: 2, marginTop: 16 },
  emptyText: { color: theme.colors.textSecondary, fontSize: 11, textAlign: "center", marginTop: 8 },
  ...
  dealerName: { color: theme.colors.textPrimary, fontWeight: "800", fontSize: 12 },
  ...
  pillValue: { fontWeight: "900", fontSize: 11 },
  pillLabel: { fontSize: 7, fontWeight: "800", letterSpacing: 1 },
  dealerBody: { paddingHorizontal: 20, paddingBottom: 14, gap: 10 },
  bodyLabel: { color: theme.colors.textMuted, fontSize: 8, fontWeight: "800", letterSpacing: 1.5, marginTop: 4 },
  completedToggle: {
    flexDirection: "row", alignItems: "center", gap: 6, alignSelf: "flex-start",
    borderWidth: 1, borderColor: theme.colors.border,
    paddingHorizontal: 10, paddingVertical: 6, borderRadius: 3,
  },
  completedToggleText: { color: theme.colors.accent, fontSize: 8, fontWeight: "800", letterSpacing: 1 },
  muted: { color: theme.colors.textMuted, fontStyle: "italic", fontSize: 11, paddingVertical: 6 },
  claimCard: {
  ...
  claimTitle: { color: theme.colors.textPrimary, fontWeight: "700", fontSize: 11 },
  claimMeta: { color: theme.colors.textSecondary, fontSize: 9, marginTop: 2 },
  claimDate: { color: theme.colors.textMuted, fontSize: 8, marginTop: 2 },
  ...
  statusPillText: { fontSize: 8, fontWeight: "800", letterSpacing: 1 },
  ...
  modalTitle: { color: theme.colors.textPrimary, fontSize: 15, fontWeight: "900", letterSpacing: 2 },
  modalSub: { color: theme.colors.textSecondary, fontSize: 10, marginTop: 4, marginBottom: 12 },
  filterDot: {
    position: "absolute",
    top: -2, right: -2,
  ...
  fLabel: { color: theme.colors.textMuted, fontSize: 8, fontWeight: "800", letterSpacing: 1.5, marginTop: 4, marginBottom: 6 },
  fSubLabel: { color: theme.colors.textMuted, fontSize: 7, fontWeight: "800", letterSpacing: 1, marginBottom: 4 },
  checkRow: {
    flexDirection: "row", alignItems: "center", gap: 10,
    paddingHorizontal: 12, paddingVertical: 10,
    borderWidth: 1, borderColor: theme.colors.border, borderRadius: 4,
  },
  checkText: { color: theme.colors.textPrimary, fontSize: 11, fontWeight: "600" },
  dateInput: {
  ...
  pickText: { flex: 1, fontSize: 11, fontWeight: "600" },
  btnGhost: {
    flex: 1,

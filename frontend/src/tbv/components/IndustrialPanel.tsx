 ...
 * stretched frame art / watermarks, so it never smears or shows baked-in
 * interiors on variable-length lists. Adds beveled metal edges, a top orange
 * accent bar, and hardware bolts in the corners.
 *

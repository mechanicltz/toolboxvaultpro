...
export const newStyles = themedStyles((c) => ({
  ...
  tabBtnText: { color: c.textSecondary, fontSize: 11, fontWeight: "800", letterSpacing: 0.5 },
  ...
  // Top-header (centerSlot) Cancel/Save buttons shown while editing — replaces
  // the page title/subtitle to free up vertical room for the form fields.
  editTopBar: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  histSeg: { flexDirection: "row", gap: 22, alignItems: "center", borderBottomWidth: 1, borderBottomColor: c.border, paddingBottom: 6 },
  histSegBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  histSegBtnActive: {},
  histSegText: { color: c.textMuted, fontSize: 13, fontWeight: "800", letterSpacing: 0.5 },
  histSegTextActive: { color: c.accent },
  histItem: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,

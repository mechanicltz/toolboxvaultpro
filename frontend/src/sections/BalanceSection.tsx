...
const styles = StyleSheet.create({
  ...
  balLabel: { color: theme.colors.textPrimary, fontSize: 11, fontWeight: "900", letterSpacing: 2 },
  histLink: { color: theme.colors.accent, fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  balAmount: { fontSize: 28, fontWeight: "900", marginTop: 8 },
  balSub: { color: theme.colors.textMuted, fontSize: 11, marginTop: 2 },
  payBtn: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  payText: { color: "#000", fontWeight: "900", fontSize: 11, letterSpacing: 1 },
  chargeBtn: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  chargeText: { color: theme.colors.danger, fontWeight: "900", fontSize: 11, letterSpacing: 1 },
  ...
  txAmount: { color: theme.colors.textPrimary, fontWeight: "900", fontSize: 16 },
  txMeta: { color: theme.colors.textMuted, fontSize: 11, fontWeight: "700", marginTop: 2, letterSpacing: 0.5 },
  txNote: { color: theme.colors.textSecondary, fontSize: 12, marginTop: 3, fontStyle: "italic" },
  btnGhost: {
    height: 44,
    borderWidth: 1,
